...
from ai_service.ocr.corrections import (
    OCR_TO_DIGIT,
    correct_char_to_digit as ocr_to_digit,
    clean_mrz_text,
)


# --------------------------------------------------
# COMMON OCR CONFUSIONS + basic character helpers now live in
# ai_service.ocr.corrections (previously duplicated here, in
# mrz_normalizer.py, and in mrz_corrector.py).
# --------------------------------------------------
